...
const CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pos { font-family: 'DM Mono', monospace; font-size: 12px; color: #00c896; }
  .neg { font-family: 'DM Mono', monospace; font-size: 12px; color: #ff4d6d; }
              ...
              <div className={`fade ${fadeIn ? "in" : ""}`}>
                ...
                <div className="grid2">
                  <div className="card">
                    ...
                    <div className="idx-row"><div className="idx-dot" style={{ background: "#00c896" }} /><div><div className="idx-name">KOSPI</div><div className="idx-val">{briefing.korea && briefing.korea.kospi}</div></div></div>
                    <div className="idx-row"><div className="idx-dot" style={{ background: "#6b9eff" }} /><div><div className="idx-name">KOSDAQ</div><div className="idx-val">{briefing.korea && briefing.korea.kosdaq}</div></div></div>
                    <div className="hl-box" style={{ background: "rgba(0,200,150,0.07)", color: "#00c896" }}>{briefing.korea && briefing.korea.highlight}</div>
                  </div>
                  <div className="card">
                    <div className="card-lbl">🇺🇸 미국 시장</div>
                    <div className="idx-row"><div className="idx-dot" style={{ background: "#f5c842" }} /><div><div className="idx-name">S&P 500</div><div className="idx-val">{briefing.us && briefing.us.sp500}</div></div></div>
                    <div className="idx-row"><div className="idx-dot" style={{ background: "#ff6b9d" }} /><div><div className="idx-name">NASDAQ</div><div className="idx-val">{briefing.us && briefing.us.nasdaq}</div></div></div>
                    <div className="hl-box" style={{ background: "rgba(245,200,66,0.07)", color: "#f5c842" }}>{briefing.us && briefing.us.highlight}</div>
                  </div>
                </div>
                <div className="card" style={{ marginBottom: 16 }}>
                  <div className="card-lbl">🌐 거시경제 지표</div>
                  <div className="macro-grid">
                    <div className="macro-item"><div className="macro-lbl">💱 원/달러 환율</div><div className="macro-val">{briefing.macro && briefing.macro.exchange_rate}</div></div>
                    <div className="macro-item"><div className="macro-lbl">🏦 금리 동향</div><div className="macro-val">{briefing.macro && briefing.macro.interest}</div></div>
                    <div className="macro-item"><div className="macro-lbl">🥇 금 / 원자재</div><div className="macro-val">{briefing.macro && briefing.macro.commodity}</div></div>
                  </div>
                </div>
                <div className="grid2">
                  <div className="card">
                      ...
                      <div key={i} className="stock-card">
                        ...
                        {stock.price && (
                          <div className="stock-price-row">
                            ...
                            <span className={isPos ? "pos" : "neg"}>{isPos ? "▲" : "▼"} {Math.abs(stock.changePercent)}%</span>
                          </div>
                        )}
